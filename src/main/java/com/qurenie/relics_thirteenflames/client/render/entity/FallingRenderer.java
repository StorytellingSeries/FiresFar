...
public class FallingRenderer extends EntityRenderer<UsableFallingBlockEntity> {
    private final BlockRenderDispatcher dispatcher;

    public FallingRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.shadowRadius = 0.5F;
        this.dispatcher = pContext.getBlockRenderDispatcher();
    }

    public void render(UsableFallingBlockEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
     ...
     */
    @Override
    public ResourceLocation getTextureLocation(UsableFallingBlockEntity pEntity) {
