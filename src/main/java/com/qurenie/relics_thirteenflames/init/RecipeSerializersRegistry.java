...
public interface RecipeSerializersRegistry {
    ...
    DeferredHolder<RecipeSerializer<?>, MontuSmithRecipe.MontuSmithSerializer> MONTU_SMITH_SERIALIZER = RECIPE_SERIALIZERS.register("montu_smith", MontuSmithRecipe.MontuSmithSerializer::new);
