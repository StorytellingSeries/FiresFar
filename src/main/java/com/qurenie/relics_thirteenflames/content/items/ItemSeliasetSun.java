				...
				.abilities(AbilitiesTemplate.builder()
						.ability(AbilityTemplate.builder("blessed_light")
								...
								.stat(AbilityStatTemplate.builder("breed_chance")
										.initialValue(10, 30)
										.targetValue(RelicsScalingModels.ADDITIVE.get(), 708)
								...
								.stat(AbilityStatTemplate.builder("radius")
										...
										.targetValue(RelicsScalingModels.ADDITIVE.get(), 30F)
						...
						.ability(AbilityTemplate.builder("heat")
								...
								.stat(AbilityStatTemplate.builder("heat_time")
										.initialValue(15, 12)
										.targetValue(RelicsScalingModels.ADDITIVE.get(), 2)
										.thresholdValue(2, 15)
										.formatValue(x -> (int) MathUtils.round(x, 0))
										.build())
								...
								.stat(AbilityStatTemplate.builder("radius")
										.initialValue(3, 3)
										.thresholdValue(3, 18)
										.targetValue(RelicsScalingModels.ADDITIVE.get(), 18)
										.formatValue(x -> (int) MathUtils.round(x, 1))
										.build())
						...
						.ability(AbilityTemplate.builder("lightning")
								...
								.stat(AbilityStatTemplate.builder("frequency")
										...
										.targetValue(RelicsScalingModels.EXPONENTIAL.get(), 120)
										.formatValue(x -> MathUtils.round(x / 20f, 1))
										.build())
								.stat(AbilityStatTemplate.builder("radius")
										.initialValue(10, 20)
										.targetValue(RelicsScalingModels.EXPONENTIAL.get(), 80)
										.formatValue(x -> MathUtils.round(x, 1))
										.build())
								.rankModifier(2, "caves")
								.build())
						.build())
