        ...
        return RelicTemplate.builder().abilities(AbilitiesTemplate.builder()
                                .ability(AbilityTemplate.builder("ranging")
                                        ...
                                        .stat(AbilityStatTemplate.builder("increasing")
                                                .initialValue(0, 1)
                                                .upgradeModifier(RelicsScalingModels.ADDITIVE.get(), 0.7)
                                                .thresholdValue(0, 4)
                                                .build()
                                        )
                                        .stat(AbilityStatTemplate.builder("damage_modifier")
                                                .initialValue(1, 1.2)
                                                .upgradeModifier(RelicsScalingModels.EXPONENTIAL.get(), 0.16)
                                                .thresholdValue(1, 4)
...
//                                        .build())
                                                .stat(AbilityStatTemplate.builder("recharge")
                                                        ...
                                                        .upgradeModifier(RelicsScalingModels.ADDITIVE.get(), -130)
                                                ...
                                                .stat(AbilityStatTemplate.builder("xp_modifier")
                                                        .initialValue(1, 1.15)
                                                        .upgradeModifier(RelicsScalingModels.EXPONENTIAL.get(), 0.12)
                                                        .thresholdValue(1, 4)
                                ...
                                .ability(AbilityTemplate.builder("one_thousand_eyes")
                                        ...
                                        .stat(AbilityStatTemplate.builder("recharge")
                                                ...
                                                .upgradeModifier(RelicsScalingModels.ADDITIVE.get(), -150)
                                                .formatValue(d -> MathUtils.round(d / 20, 1))
                                                .build()
                                        )
                                        .rankModifier(2, "mark")
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, @NotNull Player player, @NotNull InteractionHand usedHand) {
        ...
        if (entityHit != null) {
            ...
            if (hasRangModifier(player, stack, "one_thousand_eyes", "infinity")
                ...
                living.level().getEntitiesOfClass(LivingEntity.class, living.getBoundingBox().inflate(17), e -> e != player)
