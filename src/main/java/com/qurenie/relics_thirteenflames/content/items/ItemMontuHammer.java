...
//        extends RelicItem implements IFireItem
//{
...
//                                    .initialValue(6.0, 12.0)
//                                    .thresholdValue(6.0, 12.0)
...
//        float attackDamageBaseline = 1 + tier.getAttackDamageBonus();
...
//    {
//        if(ctx.getLevel().getBlockState(ctx.getClickedPos()).hasBlockEntity()) return super.useOn(ctx);
//
...
//        var itr = BlockPos.betweenClosedStream(pos.offset(-radius, -radius * 2, -radius), pos.offset(radius, 0, radius))
//                .map(BlockPos::new)
//                .iterator();
//
//        int lowestY = pos.getY() - radius * 2;
//
...
//    {
//        var radius = Mth.clamp((int) AbilityUtils.getAbilityValue(stack, "aoe", "radius"), 0, 2);
//
